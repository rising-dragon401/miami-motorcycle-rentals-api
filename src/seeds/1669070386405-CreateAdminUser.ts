...
export class CreateAdminUser1669070386405 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO user (password, is_verified, verification_code, first_name, last_name, email, phone_number, birth_date,
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DELETE FROM user where email = 'info@miamimotorcyclerentals.com';`,
    );
  }
}
